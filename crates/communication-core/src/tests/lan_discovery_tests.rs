use crate::{
    lan_discovery_signing_payload, parse_lan_endpoint_hint, validate_lan_endpoint_hint,
    LanEndpointHintError, LAN_DISCOVERY_MULTICAST_ADDR, LAN_DISCOVERY_MULTICAST_HOP_LIMIT,
    LAN_DISCOVERY_SCOPE, LAN_DISCOVERY_TTL_SECONDS,
};
...
fn rejects_non_local_or_non_ip_lan_endpoint_hints() {
    for (hint, expected) in [
        ...
        ("udp://[::1]:4040", LanEndpointHintError::NonLocalAddress),
        (
