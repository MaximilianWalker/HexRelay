...
pub use domain::{
    ...
    verify_dm_session_bootstrap_ed25519, DmCiphertextEnvelope, DmE2eeError, DmEphemeralPublicKey,
    DmEphemeralSecret, DmGroupSecret, DmSessionContext, DmSessionKey, DmSessionKind,
