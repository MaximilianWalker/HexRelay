# Migration Evidence: 0001_friend_requests

## Migration Metadata

- Migration ID: `0001_friend_requests`
- SQL Path: `services/api-rs/migrations/0001_friend_requests.sql`
- Owner: TBD
- Date (UTC): baseline
...
- Expected outcome: migration applies cleanly on empty database.
