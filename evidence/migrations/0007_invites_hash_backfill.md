# Migration Evidence: 0007_invites_hash_backfill

## Migration Metadata

- Migration ID: `0007_invites_hash_backfill`
- SQL Path: `services/api-rs/migrations/0007_invites_hash_backfill.sql`
- Owner: TBD
- Date (UTC): baseline
