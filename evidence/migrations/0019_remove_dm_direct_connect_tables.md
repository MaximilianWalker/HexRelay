...
- Command(s) executed: `cargo check -p api-rs`, `cargo test -p api-rs dm_fanout`, `cargo test -p api-rs friends`, `node scripts/validators/dm-transport-policy.mjs`, `node scripts/validators/contract-parity.mjs origin/master HEAD`
