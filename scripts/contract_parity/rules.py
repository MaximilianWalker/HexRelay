...
API_ROUTER_PATH = pathlib.Path('services/api-rs/src/app/router.rs')
API_HANDLER_DIR = pathlib.Path('services/api-rs/src/transport/http/handlers')
API_MODELS_PATH = pathlib.Path('services/api-rs/src/models.rs')
