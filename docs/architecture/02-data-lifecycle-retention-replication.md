...
- Latest meaningful change: 2026-05-11 aligned DM envelope ownership with server-node P2P message-node storage while keeping plaintext/private keys client-only.
