...
- Latest meaningful change: 2026-05-08 updated Contact Invite Share to link-only after QR scope was reserved for server invites and trusted device-link/restore flows.
