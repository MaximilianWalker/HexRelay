...
- Latest meaningful change: 2026-03-12 locked profile-device eventual-sync requirement so DM and server communication converge across active and later-active devices.
