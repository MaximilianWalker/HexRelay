...
- Latest meaningful change: 2026-03-04 added full-picture handoff and artifact gate matrices across Iterations 1-4.
...
| DM/group DM schema and messaging primitives | T4.1.1, T4.3.1, T4.3.2 |
...
| NFR: security (nonce replay, auth verification, no plaintext DM storage) | T2.3.1, T2.4.1, T4.5.2, T4.5.4 |
...
| Iteration 2 | Navigation spec trace matrix, E2EE group DM task set, realtime contract versioning policy | Web/Core/Realtime |
| Iteration 3 | TURN/NAT test environment and voice quality test profile | Platform/Realtime |
| Iteration 4 | Migration conflict policy, bundle schema/version compatibility rules, SLO alert test profile | API/Core/Platform |
