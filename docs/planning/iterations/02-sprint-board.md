...
- Latest meaningful change: 2026-04-11 marked `T4.0.1` done after finishing shared communication-layer provenance wiring and recording the Iteration 2 networking-layer evidence path.
