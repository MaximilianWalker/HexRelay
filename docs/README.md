...
- Latest meaningful change: 2026-04-03 tightened contract-parity governance for routed API parameter/request/response documentation and refreshed contributor/readiness operations guidance.
