...
- Latest meaningful change: 2026-04-03 tightened contract-parity governance further by extending routed `400` parity to local parse/normalize/validation helper flows, with refreshed contributor/readiness operations guidance.
