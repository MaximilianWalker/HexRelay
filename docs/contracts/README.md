...
- Latest meaningful change: 2026-05-18 added realtime internal HTTP route contract coverage.
...
- Realtime internal HTTP baseline: `docs/contracts/realtime-internal.openapi.yaml`; this is a service-to-service contract for API-to-realtime channel/DM dispatch and local dev-fault controls, not a public app API.
