...
- Latest meaningful change: 2026-05-18 documented selected page-limit default contract-parity coverage.
...
- Resume parity work only when:
  ...
  - new stable path, query, page-limit default, DTO type, request-header, response-header, or success semantics become worth enforcing mechanically,
