...
- Status: grouped pass now covers friend-request mutation/bootstrap routes, invite redemption routes, server membership read routes, DM thread/history read routes, and DM control-plane bad-request examples.
