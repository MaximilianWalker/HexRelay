...
- Latest meaningful change: 2026-05-14 updated contract-parity guidance after server-channel message request `serde(default)` and mention-array item-pattern checks were fixture-backed.
