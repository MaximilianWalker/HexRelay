...
- Latest meaningful change: 2026-04-06 broadened contract-parity guidance so auth/social routes now require cleaner route-scoped error examples, DM connectivity and social-graph handshake routes document richer success semantics, server-channel mutation routes document lifecycle success behavior, and directory/discovery query surfaces document normalization semantics.
