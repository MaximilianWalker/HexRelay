...
- Latest meaningful change: 2026-05-14 updated contract-parity guidance after selected routed REST query-parameter string-pattern checks were fixture-backed.
