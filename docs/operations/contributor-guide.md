...
- Latest meaningful change: 2026-04-10 matched docs-index freshness wording to the validator exactly and clarified dedicated deployment limits for process-local realtime abuse controls.
