...
|---|---|---|---|---|---|
| QA-17-20260514-contact-invite-preview-skipped | P2 | superseded | Contact invite redemption skips the documented inviter preview and explicit recipient acceptance step. | Plan-only package in `docs/planning/contact-invite-redemption-implementation-plan.md` records the still-present one-step runtime evidence, defines `CIR-APP-*` approval decisions, and keeps runtime Contacts Hub/API behavior blocked until explicit approval chooses preview-then-accept or an approved one-step flow. | 2026-05-18T07:59:28Z |
...
|---|---|---|
| 2026-05-18T07:59:28Z | Codex automation | Reclassified `QA-17-20260514-contact-invite-preview-skipped` as `superseded` by the approval-pending contact-invite redemption plan so automation does not implement unapproved Contacts Hub/API behavior. |
